...
public class TankSystem : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            if (pi.inputName == "shoot") shootButton = pi.inputKey;
        }
    ...
    [HideInInspector]
    public KeyCode shootButton;                // The input axis that is used for launching shells.
    ...
    public void GiveEffect(Effect effectToGive, float power)
    {
        ...
        else if (effectToGive == Effect.Bomb)
        {
            CommitSudoku();
        }
    }
